...
public class ServiceCustomer {
   ...
   //Lấy thông tin khách hàng từ email người dùng
//    public ModelKhachHang getCustomerByEmail(String email) throws SQLException {
//        ModelKhachHang data = null;
//        String sql = "SELECT ID_KH, TenKH, DATE_FORMAT(Ngaythamgia, '%d-%m-%Y') AS NgayTG, Doanhso, Diemtichluy FROM KhachHang WHERE Email=?";
//        PreparedStatement p = con.prepareStatement(sql);
//        p.setString(1, email);
//        ResultSet r = p.executeQuery();
//        while (r.next()) {
...
//    }
   ...
   //Điều chỉnh trạng thái bàn thành "Dang dung bua" sau khi khách hàng order món ăn.
